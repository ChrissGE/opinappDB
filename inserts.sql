...
-- Insertar datos en la tabla 'questionaryMenu'
INSERT INTO questionaryMenu (id_questionary) VALUES
    (1), (1), (1), (2), (2), (2), (2);

-- Insertar textos para cuestionarios
INSERT INTO texts (id_language, text) VALUES
...
-- Mapear preguntas a cuestionarios
...
-- Mapear preguntas a cuestionarios
SET @company_code_cuestionario = 'E73463259'; -- INSERTAR COMPANY CODE
...
-- Insertar condiciones de preguntas
...
-- Insertar preguntas para otro cuestionario
INSERT INTO questions (text, question_type) VALUES 
...
-- Mapear texto-pregunta para otro cuestionario
INSERT INTO mapTextQuestions(id_questions, id_text)
SELECT q.id_questions, t.id_text
FROM (
    SELECT id_questions, ROW_NUMBER() OVER (ORDER BY id_questions) AS row_num
...
-- Mapear preguntas a otro cuestionario
SET @company_code_cuestionario_otro  = 'U31477490'; -- INSERTAR COMPANY CODE
...
WHERE id_questionary IN (
    SELECT id_questionary
    FROM questionaries
    WHERE company_code = @company_code_cuestionario_otro
);
...
-- Insertar condiciones de preguntas para otro cuestionario
INSERT INTO question_condition (id_questions, id_questionaryMenu, answer_value, score_value)
SELECT 
    mq.id_questions, 
    mq.id_questionaryMenu, 
